...
namespace MarekSkopal\MsFeatures\Hooks;
...
class ItemsProcFunc
{
    ...
    {
        /** @var array{"tx_msfeatures."?: array{"templateLayouts."?: array<string, string>}} $pagesTsConfig */
        $pagesTsConfig = BackendUtility::getPagesTSconfig($pageUid);

        return $pagesTsConfig['tx_msfeatures.']['templateLayouts.'] ?? [];
    }
    ...
    private function getTemplateLayoutsFromGlobals(): array
    {
         ...
         */
        $templateLayouts = $GLOBALS['TYPO3_CONF_VARS']['EXT']['ms_features']['templateLayouts'] ?? [];
